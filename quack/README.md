...
- Navigate to `quack` folder
- Select `quack.bot` file
...
msbot clone services --name "quack" --code-dir "." --location <azure region like eastus, westus, westus2 etc.> --sdkLanguage "Node" --folder deploymentScripts/msbotClone --verbose
```
